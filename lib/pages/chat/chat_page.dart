...
class ChatPage extends StatefulWidget {
  ChatPage(this.selectedCustomerUID, {super.key});
...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> sendMessage() async {
    ...
    final message = Message(customerUID, widget.selectedCustomerUID != null,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            "Связь с ${widget.selectedCustomerUID == null ? "продавцом" : "клиентом"}"),
      ),
      body: Column(
        children: [
          Expanded(
              child: chatMessages.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        double rightMargin;
                        bool isMessageOwner =
                            widget.selectedCustomerUID == null &&
                        ...
                        return Column(
                          children: [
                            ...
                            Align(
                                alignment: alignment,
                                child: Text(
                                  "${selectedMessage.timestamp.day}.${selectedMessage.timestamp.month} ${selectedMessage.timestamp.hour}:${selectedMessage.timestamp.minute}",
                                  style:
