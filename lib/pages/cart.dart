...
import 'products/item_view.dart';
        ...
        children: [
          Padding(
            ...
            child: cartItems.isEmpty
                ? const Center(
                    child: Text("Вы пока ничего не добавили в Корзину."))
                : ListView.builder(
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          await http.post(Uri(
                              ...
                              port: appData.serverPort,
                              path: "/order",
                              queryParameters: {"uid": appData.account!.uid}));
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(widget.cartItem.item.Category,
                          ...
                          onPressed: () async {
                            if (widget.cartItem.Count > 1) {
                              ...
                              http.put(Uri(
                                  ...
                                  queryParameters: {
                                    "product_id":
                                        widget.cartItem.item.ID.toString(),
                                    "count": widget.cartItem.Count.toString(),
                                    "uid": appData.account!.uid
                                  }));
                              appData.cartState!.forceUpdateState();
                            }
